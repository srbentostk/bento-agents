...
import bubbleStatusData from './bubble-strike.json';
...
/** Strike bubble: white square with red exclamation mark, and a tail pointer (11x13) */
export const BUBBLE_STRIKE_SPRITE: SpriteData = resolveBubbleSprite(bubbleStatusData);
